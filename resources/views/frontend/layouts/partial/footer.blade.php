BANGLADESH</h2>
                    <a class="btn btn-primary js-scroll-trigger" href="{{route('homepage')}}">Buy Ticket</a>
                </div>
            </div>
        </header>
        <!-- About-->
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card py-4 h-100">
                            <div class="card-body text-center">
                                ...
                                <h4 class="text-uppercase m-0">COMFORTABLE</h4>
                                <hr class="my-4" />
                                <div class="small text-black-50">
We have very large leg space in between seats.You can spend 12 hours without any discomfort in our seats</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3 mb-md-0">
